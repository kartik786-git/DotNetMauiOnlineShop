...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [124 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 12127328; uint32_t buffer_offset
	}, ; 121: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 21536, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 12298336; uint32_t buffer_offset
	}, ; 122: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2019328, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 12319872; uint32_t buffer_offset
	} ; 123: Mono.Android
], align 4

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 14339200, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [14339200 x i8] zeroinitializer, align 1
